...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('huoxin/follow-own-discussion', function () {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_SettingsPage__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'notificationsItems', function (items) {
    var _this$user$preference,
      _this = this;
    items.add('followOnCreate', flarum_common_components_Switch__WEBPACK_IMPORTED_MODULE_3___default().component({
      className: 'followOnCreate',
      state: (_this$user$preference = this.user.preferences()) == null ? void 0 : _this$user$preference.followAfterCreate,
      onchange: function onchange(value) {
        _this.followOnCreateLoading = true;
        _this.user.savePreferences({
          followAfterCreate: value
        }).then(function () {
          _this.followOnCreateLoading = false;
          m.redraw();
        });
      },
      loading: this.followOnCreateLoading
    }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('huoxin-follow-own-discussion.forum.default-follow-after-create-label')), 8);
  });
});
